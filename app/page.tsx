      ...
      {mobileOpen && (
        <div className="md:hidden bg-card border-t border-primary/15 px-6 py-4 flex flex-col gap-4 text-sm font-medium text-foreground">
          ...
          <div className="flex gap-3 pt-2 border-t border-primary/15">
            <Link href="/login" className="flex-1 text-center px-4 py-2 text-primary border border-primary rounded-lg hover:bg-primary hover:text-primary-foreground transition-all">
              Log In
            </Link>
            <Link href="/register" className="flex-1 text-center px-4 py-2 text-primary-foreground bg-gradient-to-r from-primary to-accent rounded-lg hover:opacity-90">
              Register
            </Link>
          </div>
        </div>
...
function ForumSpotlightSection() {
  return (
    <section id="forum-section" className="py-24 bg-background">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="font-heading text-4xl font-bold text-foreground leading-[1.1] tracking-tight">
              Ask openly, reply safely, and learn from a{" "}
              <span className="italic bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                supportive community
              </span>
            </h2>
            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
              The MAAYA forum gives members a place to post questions, share experiences, and
              keep discussions going with replies and upvotes. Admin moderation keeps the space
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/forum"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary to-accent px-6 py-3 text-sm font-semibold text-primary-foreground shadow-sm hover:opacity-90 transition-opacity"
              >
                Explore the forum
              </Link>
              <Link
                href="/register"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-primary/30 px-6 py-3 text-sm font-semibold text-primary hover:bg-primary/5 transition-all"
              >
                Join the community
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
              <div className="flex items-center justify-between gap-3 border-b border-border/60 pb-4">
                <div>
                  <p className="font-heading text-xl font-semibold text-foreground">Community feed</p>
                  <p className="text-xs text-muted-foreground">Real questions, thoughtful replies</p>
                </div>
              ...
              <div className="mt-5 space-y-4">
                <div className="rounded-2xl border border-primary/15 bg-primary/5 p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">Posted 12 min ago</span>
                  </div>
                  <p className="mt-3 text-sm font-semibold text-foreground">
                    Is it normal to feel very tired before my cycle starts?
                  </p>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                    I&apos;ve noticed it for the last few months and wanted to know if others track this too.
                  </p>
                ...
                <div className="ml-6 rounded-2xl border border-secondary/15 bg-secondary/5 p-4">
                  <div className="flex items-center gap-2">
                    <span className="rounded-full border border-secondary/20 bg-secondary/10 px-2.5 py-1 text-[11px] font-semibold text-secondary">
                      Admin
                    </span>
                    <span className="text-xs text-muted-foreground">Moderator reply</span>
                  </div>
                  <p className="mt-3 text-sm leading-relaxed text-foreground">
                    Yes, many members discuss energy changes around their cycle. Keeping notes in the
                    forum can help you spot patterns and get better support.
                  </p>
                </div>
              </div>
            </div>

            <div className="absolute -right-4 -top-4 hidden rounded-2xl border border-primary/15 bg-card px-4 py-3 shadow-lg sm:block">
